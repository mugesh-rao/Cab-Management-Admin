...
<div className="flex flex-row gap-4 ">
        ...
        <div className=" m-2 bg-white rounded-lg flex flex-col gap-6 shadow-lg overflow-x-scroll">
          <table className="border-collapse">
            ...
            {Trip.length > 0 && (
              <tbody className="table-row-group  text-lg font-sans divide-x-0  uppercase rounded-md">
